(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.CapsuleLint = {}));
  ...
  var EventTree_1 = EventTree$1;

  const EventTree = EventTree_1;

  var htmlValidContentModel = {
  ...
  Object.keys(rules).forEach((key) => {
      htmlhint.exports.HTMLHint.addRule(rules[key]);
  });

  function lint(html, config) {
      return htmlhint.exports.HTMLHint.verify(html, config || defaultConfig).map(error => {    
